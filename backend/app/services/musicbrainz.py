...
class MusicBrainzClient:
    """Async client for MusicBrainz and Cover Art Archive APIs."""
    ...
    async def get_cover_art_url(self, mbid: str) -> str | None:
        """
        Get album cover art URL from Cover Art Archive.
        ...
        """
        # Cover Art Archive uses release-group ID for front covers
        # Returns a redirect to the actual image
        try:
